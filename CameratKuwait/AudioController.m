...
- (void)configureAudioPlayer {
    ...
    NSString *backgroundMusicPath = [[NSBundle mainBundle] pathForResource:@"button-8" ofType:@"mp3"];
...
- (void)configureSystemSound {
	...
	NSString *pewPewPath = [[NSBundle mainBundle] pathForResource:@"button-8" ofType:@"mp3"];
